...
export const AUTHORIZATION_EXCEPTION = 'Something went wrong please try again later';
export const REGISTRATION_EXCEPTION = 'Something went wrong please try again later';
export const LOGOUT_EXCEPTION = 'Something went wrong please try again later';
...
export const LENGTH_OF_PASSWORD_EXCEPTION =
    'Length of password can not be less than 3 symbols.';
...
export const UNAUTHORIZED_EXCEPTION = '403 Unauthorized';
